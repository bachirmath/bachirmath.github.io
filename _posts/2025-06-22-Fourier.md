...
<iframe src="/assets/fourier-plot-0.html?v=1.3" width="650" height="500" frameborder="0"></iframe>
...
$$b_n=\frac{2}{\pi}\big(-\frac{x\cos(nx)}{n}\Big|_{0}^\pi + \frac{1}{n}\int_{0}^\pi \cos(nx)dx\big)$$

$$b_n=\frac{2}{\pi}\left[-\frac{\pi\cos(n\pi)}{n} + \frac{1}{n^2}\sin(nx)\Big|_{0}^\pi\right]$$

$$b_n=\frac{2}{\pi}\left[-\frac{\pi\cos(n\pi)}{n} + 0\right] = -\frac{2\cos(n\pi)}{n} = \frac{2(-1)^{n+1}}{n}$$
...
<iframe src="/assets/fourier-plot-1.html" width="650" height="550" frameborder="0"></iframe>
