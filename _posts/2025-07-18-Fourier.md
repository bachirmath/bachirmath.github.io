...
<div style="position: relative; padding-bottom: 91.67%; height: 0; overflow: hidden; max-width: 100%; border: 1px solid #ccc; border-radius: 8px;">
  <iframe 
    src="/assets/fourier-plot-0.html?v=1.3"
    title="Fourier Approximation"
    style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;">
  </iframe>
</div>

<p style="text-align: center; margin-top: 0.5rem; direction: rtl;">
  <em>الشكل: تقريب الدالة <code>f</code> بسلسلة <code>S_m(x)</code> – يمكنك تغيير قيمة <code>m</code> باستخدام الشريط المنزلق</em>
</p>
...
<iframe src="/assets/fourier-plot-1.html" width="600" height="550" frameborder="0"></iframe>
