...
<div style="display: block; width: 100%; max-width: 100%; overflow-x: auto;">
  <iframe 
    src="/assets/fourier-plot-0.html?v=1.3"
    title="Fourier Approximation"
    style="min-width: 100%; height: 600px; border: none; display: block;"
    allowfullscreen>
  </iframe>
</div>

<p style="text-align: center; direction: rtl; margin-top: 0.5rem;">
